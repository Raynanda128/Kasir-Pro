...
-- 8. TABEL BUSINESSES & MEMBERS (Fitur Multi-Cabang & Tim)
...
-- HAPUS BATASAN ROLE LAMA AGAR BISA MEMASUKKAN ADMIN, MANAGER, KASIR
ALTER TABLE public.business_members DROP CONSTRAINT IF EXISTS business_members_role_check;
ALTER TABLE public.business_invitations DROP CONSTRAINT IF EXISTS business_invitations_role_check;
...
ALTER TABLE public.business_invitations DISABLE ROW LEVEL SECURITY;
