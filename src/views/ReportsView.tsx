...
export const ReportsView: React.FC<ReportsViewProps> = ({ stats }) => {
  ...
  const handleExportCSV = () => {
    try {
      const headers = ['Invoice', 'Tanggal', 'Kasir', 'Metode Bayar', 'Subtotal', 'Diskon', 'Pajak', 'Total', 'Keuntungan'];
      const rows = stats.recentTransactions.map(t => [
        t.invoiceNumber,
      ...
      link.setAttribute('download', `Laporan_Penjualan_KasirPro_${Date.now()}.csv`);
